---
tags: ["Option", "Snapshot", "Greeks", "First Order", "Real-time Data"]
created: 2023-10-27
reviewed: false
source_origin: "openapiv3.yaml"
---
# Option Snapshot Greeks First Order Endpoint

The `/option/snapshot/greeks/first_order` endpoint of the [Theta Data v3](../../entities/theta-data-v3.md) API provides real-time snapshot calculations for first-order [Option Greeks](../concepts/option-greeks.md) (Delta, Theta, Vega, Rho, Epsilon, Lambda, Implied Volatility, IV Error) for options contracts. This data is returned for all contracts that lie on a provided expiration.

## Endpoint Details:
*   **Path**: `/option/snapshot/greeks/first_order`
*   **Method**: `GET`
*   **Summary**: First Order Greeks
*   **Operation ID**: `option_snapshot_greeks_first_order`
