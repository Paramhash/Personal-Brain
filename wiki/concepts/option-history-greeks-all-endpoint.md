---
tags: ["Option", "History", "Greeks", "All Greeks", "Time Series"]
created: 2023-10-27
reviewed: false
source_origin: "openapiv3.yaml"
---
# Option History Greeks All Endpoint

The `/option/history/greeks/all` endpoint of the [Theta Data v3](../../entities/theta-data-v3.md) API provides historical calculations for all [Option Greeks](../concepts/option-greeks.md) for options contracts. This data is returned for all contracts that share the same provided symbol and expiration, at specified [Time Intervals](../../concepts/time-intervals.md).

## Endpoint Details:
*   **Path**: `/option/history/greeks/all`
*   **Method**: `GET`
*   **Summary**: All Greeks
*   **Operation ID**: `option_history_greeks_all`
