---
tags: ["Option", "History", "Trade Greeks", "Implied Volatility"]
created: 2023-10-27
reviewed: false
source_origin: "openapiv3.yaml"
---
# Option History Trade Greeks Implied Volatility Endpoint

The `/option/history/trade_greeks/implied_volatility` endpoint of the [Theta Data v3](../../entities/theta-data-v3.md) API provides historical implied volatilities for options contracts, calculated using the trade price reported by [OPRA (Options Price Reporting Authority)](../../entities/opra.md). This data is returned for all contracts that share the same provided symbol and expiration.

## Endpoint Details:
*   **Path**: `/option/history/trade_greeks/implied_volatility`
*   **Method**: `GET`
*   **Summary**: Trade Implied Volatility
*   **Operation ID**: `option_history_trade_greeks_implied_volatility`
*   **Minimum Subscription**: `professional`
*   **History Access**: `true`
*   **Description**:
    *   Returns implied volatilities calculated using the trade reported by [OPRA (Options Price Reporting Authority)](../../entities/opra.md).
...
df = client.option_history_trade_greeks_implied_volatility(symbol='AAPL', expiration=date(2024, 11, 8))
```
