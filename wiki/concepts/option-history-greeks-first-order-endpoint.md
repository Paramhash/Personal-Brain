---
tags: ["Option", "History", "Greeks", "First Order", "Time Series"]
created: 2023-10-27
reviewed: false
source_origin: "openapiv3.yaml"
---
# Option History Greeks First Order Endpoint

The `/option/history/greeks/first_order` endpoint of the [Theta Data v3](../../entities/theta-data-v3.md) API provides historical calculations for first-order [Option Greeks](../concepts/option-greeks.md) (Delta, Theta, Vega, Rho, Epsilon, Lambda, Implied Volatility, IV Error) for options contracts. This data is returned for all contracts that share the same provided symbol and expiration, at specified [Time Intervals](../../concepts/time-intervals.md).

## Endpoint Details:
*   **Path**: `/option/history/greeks/first_order`
*   **Method**: `GET`
*   **Summary**: First Order Greeks
*   **Operation ID**: `option_history_greeks_first_order`
...
## Responses:
*   **200 OK**: Returns first order Greeks for an option contract.
    ...
    *   **Schema**: An array of objects, each with:
        ...
        *   `delta`, `theta`, `vega`, `rho`, `epsilon`, `lambda`, `implied_vol`, `iv_error`: First-order [Option Greeks](../concepts/option-greeks.md) and related metrics.
