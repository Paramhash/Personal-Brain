---
tags: ["Option", "History", "Trade Greeks", "All Greeks"]
created: 2023-10-27
reviewed: false
source_origin: "openapiv3.yaml"
---
# Option History Trade Greeks All Endpoint

The `/option/history/trade_greeks/all` endpoint of the [Theta Data v3](../../entities/theta-data-v3.md) API provides historical calculations for all [Option Greeks](../concepts/option-greeks.md) for every trade reported by [OPRA (Options Price Reporting Authority)](../../entities/opra.md). This data is returned for all contracts that share the same provided symbol and expiration.

## Endpoint Details:
*   **Path**: `/option/history/trade_greeks/all`
*   **Method**: `GET`
*   **Summary**: All Trade Greeks
*   **Operation ID**: `option_history_trade_greeks_all`
...
## Responses:
*   **200 OK**: Returns all trade Greeks for an option contract.
