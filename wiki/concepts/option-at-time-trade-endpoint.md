---
tags: ["Option", "At-Time", "Trade", "Historical Data"]
created: 2023-10-27
reviewed: false
source_origin: "openapiv3.yaml"
---
# Option At-Time Trade Endpoint

The `/option/at_time/trade` endpoint of the [Theta Data v3](../../entities/theta-data-v3.md) API retrieves the last trade reported by [OPRA (Options Price Reporting Authority)](../../entities/opra.md) at a specified millisecond of the day, for a given options contract and date range.

## Endpoint Details:
*   **Path**: `/option/at_time/trade`
*   **Method**: `GET`
*   **Summary**: Trade
*   **Operation ID**: `option_at_time_trade`
*   **Minimum Subscription**: `standard`
*   **History Access**: `true`
*   **Description**:
    *   Returns the last trade reported by [OPRA (Options Price Reporting Authority)](../../entities/opra.md) at a specified millisecond of the day.
    *   [Trade Condition Mappings](/Articles/Errors-Exchanges-Conditions/Trade-Conditions.html) can be found in the documentation.
    *   Extended trade conditions are not reported by [OPRA (Options Price Reporting Authority)](../../entities/opra.md) for options, so they can be ignored.
    *   The `time_of_day` [API Parameter](../../concepts/api-parameters.md#time-of-day) represents the 00:00:00.000 ET that the trade should be provided for.
...
*   `format` (Optional): The format of the data when returned to the user. See [API Parameters](../../concepts/api-parameters.parameters.md#format) and [Data Formats](../../concepts/data-formats.md).

## Responses:
*   **200 OK**: Returns the last trade for an option contract.
