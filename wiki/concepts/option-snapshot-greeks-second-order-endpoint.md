---
tags: ["Option", "Snapshot", "Greeks", "Second Order", "Real-time Data"]
created: 2023-10-27
reviewed: false
source_origin: "openapiv3.yaml"
---
# Option Snapshot Greeks Second Order Endpoint

The `/option/snapshot/greeks/second_order` endpoint of the [Theta Data v3](../../entities/theta-data-v3.md) API provides real-time snapshot calculations for second-order [Option Greeks](../concepts/option-greeks.md) (Gamma, Vanna, Charm, Vomma, Veta, Implied Volatility, IV Error) for options contracts. This data is returned for all contracts that lie on a provided expiration.

## Endpoint Details:
*   **Path**: `/option/snapshot/greeks/second_order`
*   **Method**: `GET`
*   **Summary**: Second Order Greeks
*   **Operation ID**: `option_snapshot_greeks_second_order`
*   **Minimum Subscription**: `professional`
*   **Description**:
    *   Retrieves a real-time last second-order Greeks calculation for all option contracts that lie on a provided expiration.
...
## Responses:
*   **200 OK**: Returns second order Greeks for an option contract.
    ...
    *   **Schema**: An array of objects, each with:
        ...
        *   `gamma`, `vanna`, `charm`, `vomma`, `veta`, `implied_vol`, `iv_error`: Second-order [Option Greeks](../concepts/option-greeks.md) and related metrics.
